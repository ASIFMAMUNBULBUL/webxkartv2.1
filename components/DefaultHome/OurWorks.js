        ...
        <section className="case-studies-area ptb-100 bg-fcfbfb">
          <div className="container">
            <div className="section-title">
              <h2>Our Works</h2>
              <p>
                We have produced a wide range of projects for the last 6 years,
                We have a team of highly skilled and experienced architects and
                designers who are able to provide innovative and creative
                solutions.
              </p>
            </div>
